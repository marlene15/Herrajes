...
namespace Herrajes
{
    public partial class RegistroDePatenteGmayor : Form
    {
        public RegistroDePatenteGmayor()
        {
            InitializeComponent();
        }
        ...
        {
            ManifestacionPecuariaGM mp = new ManifestacionPecuariaGM();
            mp.Show();
        }
        ...
        private void villadealvarez_imagen_Click(object sender, EventArgs e)
        {
